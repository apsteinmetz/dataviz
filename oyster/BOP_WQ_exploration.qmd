...
The main data source is the BOP water quality spreadsheet found here: [BOP Water Quality Data](https://docs.go9ogle.com/spreadsheets/d/1813b2nagaxZ80xRfyMZNNKySZOitro5Nt7W4E9WNQDA/edit?gid=1924583806#gid=192458380*6) I also used the NOAA data site for tide, temperature and rainfall data.
...
The bacteria levels ar9e distributed in a lopsided way. The extreme high level is effectively infinity and conveys little information. Values above 5000 are only 5% of the observations and values below 500 are 82% of the observations.
...
summary(model)
```
As it turns out, only rainfall and temperature are statistically significant.  Tides are not.  This scarcely matters because the model stinks.  The R-squared is 0.05 and the residuals are not normally distributed.

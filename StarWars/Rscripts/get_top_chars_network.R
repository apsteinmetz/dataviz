...
# import data tables
Ep4 = read.table("./text_files/SW_EpisodeIV.txt", stringsAsFactors = FALSE)
Ep5 = read.table("./text_files/SW_EpisodeV.txt", stringsAsFactors = FALSE)
Ep6 = read.table("./text_files/SW_EpisodeVI.txt", stringsAsFactors = FALSE)
